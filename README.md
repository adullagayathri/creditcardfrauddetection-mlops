...
```bash
git clone https://github.com/adullagayathri/creditCardFraudDetection.git
...
Gayathri is an AI/ML Engineer with experience in developing and deploying machine learning, generative AI, and production AI systems. Her work focuses on building scalable AI infrastructure, model serving, and monitoring using tools like Docker, Flask, and MLOps best practices.
